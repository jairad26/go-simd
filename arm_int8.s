...
// func AddInt8VecSIMD(a, b, result *int8, n int)
TEXT ·AddInt8VecSIMD(SB), NOSPLIT, $0-32
...
// func SubInt8VecSIMD(a, b, result *int8, n int)
TEXT ·SubInt8VecSIMD(SB), NOSPLIT, $0-32
    MOVD result+0(FP), R0
    MOVD a+8(FP), R1
    MOVD b+16(FP), R2
    MOVD len+24(FP), R3
...
TEXT ·DotInt8VecSIMD16(SB), NOSPLIT, $0-32
    MOVD a_base+0(FP), R0
    MOVD b_base+8(FP), R1
    MOVD len+16(FP), R2
...
TEXT ·DotInt8VecSIMD32(SB), NOSPLIT, $0-32
    MOVD a_base+0(FP), R0
    MOVD b_base+8(FP), R1
    MOVD len+16(FP), R2
...
TEXT ·DotInt8VecSIMD64(SB), NOSPLIT, $0-32
    MOVD a_base+0(FP), R0
    MOVD b_base+8(FP), R1
    MOVD len+16(FP), R2
